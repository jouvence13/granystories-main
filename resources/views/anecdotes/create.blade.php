                ...
                <div class="form-items">
                    ...
                    <form action="{{ route('anecdote.store') }}" method="POST" class="requires-validation" novalidate>
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" id="ville" name="ville" placeholder="Ville" maxlength="30" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" id="pays" name="pays" placeholder="Pays" maxlength="30" required>
